 ...
 * 
 */
public class YearFoundedFuserMostRecent extends AttributeValueFuser<LocalDateTime, Movie, Attribute> {

	public YearFoundedFuserMostRecent() {
		super(new MostRecent<LocalDateTime, Movie, Attribute>());
	}
