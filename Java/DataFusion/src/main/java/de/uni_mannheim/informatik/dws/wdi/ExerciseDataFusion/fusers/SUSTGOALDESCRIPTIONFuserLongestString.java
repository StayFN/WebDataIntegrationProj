 ...
 * 
 */
public class SUSTGOALDESCRIPTIONFuserLongestString extends
		AttributeValueFuser<String, Company, Attribute> {

	public SUSTGOALDESCRIPTIONFuserLongestString() {
	...
	public void fuse(RecordGroup<Company, Attribute> group, Company fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		{
			fusedRecord.setSustGoalDescription(fused.getValue());
			fusedRecord.setAttributeProvenance(Company.SUSTGOALDESCRIPTION,
