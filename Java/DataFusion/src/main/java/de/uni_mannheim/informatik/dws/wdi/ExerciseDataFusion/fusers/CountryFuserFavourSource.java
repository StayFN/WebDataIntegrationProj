 ...
 * 
 */
public class CountryFuserFavourSource extends AttributeValueFuser<String, Company, Attribute> {

	public CountryFuserFavourSource() {
	...
	public void fuse(RecordGroup<Company, Attribute> group, Company fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setAttributeProvenance(Company.COUNTRY,
