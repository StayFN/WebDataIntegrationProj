 ...
 * 
 */
public class CompanyNameComparatorJaroWrinkler implements Comparator<Company, Attribute> {
	...
	public double compare(
		...
		String s1 = record1.getCompanyName();
		String s2 = record2.getCompanyName();
    ...
    private String preprocessCompanyName(String companyName) {
        if (companyName != null) {
            ...
            companyName = companyName.replaceAll("(?i)Inc\\.?", "");
            companyName = companyName.replaceAll("(?i)Corporation", "");
